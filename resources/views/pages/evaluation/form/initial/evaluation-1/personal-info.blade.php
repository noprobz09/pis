	...
	<div class="x_content">
	  	<div class="clearfix form-horizontal form-label-left">
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <input type="text" class="form-control" name="employment" placeholder="Employment/Work">
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <input type="text" class="form-control" name="referring_physician" placeholder="Referring Physician">
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <textarea  class="form-control" name="medical_diagnosis" placeholder="Medical Diagnosis"></textarea>
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <textarea  class="form-control" name="reasons_for_referral" placeholder="Reasons for Referral"></textarea>
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <input type="text" class="form-control" name="date_initial_evaluation" placeholder="Date of Initial Evaluation">
		      </div>
		    </div>
		    ...
		    <div class="form-group">
		      ...
		      <div class="col-md-9 col-sm-9 col-xs-12">
		        <textarea  class="form-control" name="informants_reliability" placeholder="Informants and Reliability"></textarea>
		      </div>
		    </div>

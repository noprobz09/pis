	...
	<div class="col-xs-3">
        ...
        <ul class="nav nav-tabs tabs-left">
          	<li role="presentation" class="active">
				<a href="#personal-info" id="personal-info-tab" role="tab" data-toggle="tab" aria-expanded="true">Personal Data</a>
			</li>
	...
	<div class="col-xs-9">
		...
		<div class="tab-content">
		  <div class="tab-pane active" id="personal-info">		    
		  	@include('pages.patient.form.evaluation-1.personal-info')
		  </div>
		  <div class="tab-pane" id="home-situation">
		  	@include('pages.patient.form.evaluation-1.home-situation')
		  </div>
		  <div class="tab-pane" id="general-status">
		  	@include('pages.patient.form.evaluation-1.general-status')
		  </div>
		  <div class="tab-pane" id="social-health">
		  	@include('pages.patient.form.evaluation-1.social-health')
		  </div>
		  <div class="tab-pane" id="hpi">
		  	@include('pages.patient.form.evaluation-1.hpi')
		  </div>
		  <div class="tab-pane" id="ancillary-service">
		  	@include('pages.patient.form.evaluation-1.ancillary-service')
		  </div>
		  <div class="tab-pane" id="laboratory-results">
		  	@include('pages.patient.form.evaluation-1.laboratory-results')
		  </div>
		  <div class="tab-pane" id="activities">
		  	@include('pages.patient.form.evaluation-1.activities')
		  </div>
		  <div class="tab-pane" id="family-history">
		  	@include('pages.patient.form.evaluation-1.family-history')
		  </div>
		  <div class="tab-pane" id="medical-surgical-history">
		  	@include('pages.patient.form.evaluation-1.medical-surgical-history')
		  </div>
		  <div class="tab-pane" id="inspections">
		  	@include('pages.patient.form.evaluation-1.inspections')
		  </div>
		  <div class="tab-pane" id="vital-signs">
		  	@include('pages.patient.form.evaluation-1.vital-signs')
		  </div>
		  <div class="tab-pane" id="grading-pulse">
		  	@include('pages.patient.form.evaluation-1.grading-pulse')
		  </div>
		  <div class="tab-pane" id="findings1">
		  	@include('pages.patient.form.evaluation-1.findings1')
		  </div>
		</div>
	</div>
</div>